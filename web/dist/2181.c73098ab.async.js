  ...
  [2181],
  {
    22181: function (e, t, l) {
      ...
      var a = l(62435),
        ...
        i = l(84089),
        d = function (e, t) {
          return a.createElement(i.Z, (0, s.Z)({}, e, { ref: t, icon: o }));
        };
      var h = a.forwardRef(d),
        M = l(93967),
        E = l.n(M),
        m = l(53124);
      var k = () =>
      ...
      const L = (e) => {
          ...
          return {
            [t]: {
              padding: `${(0, F.bf)(e.calc(s).mul(2).equal())} ${(0, F.bf)(n)}`,
              '&-rtl': { direction: 'rtl' },
            },
            [`${t} ${t}-image`]: {
              width: e.imageWidth,
            ...
            [`${t} ${t}-content`]: {
              marginTop: s,
              padding: `${(0, F.bf)(s)} ${(0, F.bf)(e.calc(r).mul(2.5).equal())}`,
        ...
        B = (e) => {
          const { componentCls: t, iconCls: l } = e;
          return {
            [`${t}-success ${t}-icon > ${l}`]: {
              color: e.resultSuccessIconColor,
            },
            [`${t}-error ${t}-icon > ${l}`]: { color: e.resultErrorIconColor },
            [`${t}-info ${t}-icon > ${l}`]: { color: e.resultInfoIconColor },
            [`${t}-warning ${t}-icon > ${l}`]: {
      ...
      const W = { success: r.Z, error: n.Z, info: c.Z, warning: h },
        g = { 404: k, 500: p, 403: D },
        A = Object.keys(g),
        j = (e) => {
          let { prefixCls: t, icon: l, status: r } = e;
          const n = E()(`${t}-icon`);
          if (A.includes(`${r}`)) {
            const e = g[r];
          ...
          const c = a.createElement(W[r]);
          return null === l || !1 === l
            ? null
            : a.createElement('div', { className: n }, l || c);
        },
        z = (e) => {
          let { prefixCls: t, extra: l } = e;
          return l
            ? a.createElement('div', { className: `${t}-extra` }, l)
            : null;
        },
        $ = (e) => {
          let {
          ...
          return u(
            a.createElement(
              'div',
              { className: B, style: v },
              a.createElement(j, { prefixCls: F, status: i, icon: d }),
              a.createElement('div', { className: `${F}-title` }, c),
              n && a.createElement('div', { className: `${F}-subtitle` }, n),
              a.createElement(z, { prefixCls: F, extra: h }),
              o && a.createElement('div', { className: `${F}-content` }, o),
            ),
          );
        };
      ($.PRESENTED_IMAGE_403 = g[403]),
        ($.PRESENTED_IMAGE_404 = g[404]),
        ($.PRESENTED_IMAGE_500 = g[500]);
      var H = $;
    },
  },
]);
//# sourceMappingURL=2181.c73098ab.async.js.map
