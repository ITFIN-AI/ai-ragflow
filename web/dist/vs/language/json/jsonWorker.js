    ...
    function tr(e, t) {
      ...
      function f() {
        switch (s.getTokenError()) {
          case 4:
            return (
              u(A('Invalid unicode sequence in string.'), M.InvalidUnicode), !0
            );
          case 5:
            return (
              u(
          ...
          case 3:
            return (
              u(A('Unexpected end of number.'), M.UnexpectedEndOfNumber), !0
            );
          case 1:
            return (
              u(A('Unexpected end of comment.'), M.UnexpectedEndOfComment), !0
            );
          case 2:
            return (
              u(A('Unexpected end of string.'), M.UnexpectedEndOfString), !0
            );
          case 6:
            return (
              u(
...
$3`,
    ...
    var it = class {
      ...
      findDocumentSymbols(t, r, n = { resultLimit: Number.MAX_VALUE }) {
        ...
        return (
          a && n && n.onResultLimitExceeded && n.onResultLimitExceeded(o), u
        );
      }
      findDocumentSymbols2(t, r, n = { resultLimit: Number.MAX_VALUE }) {
        ...
        return (
          u && n && n.onResultLimitExceeded && n.onResultLimitExceeded(o), c
        );
      }
      getSymbolKind(t) {
        switch (t) {
      ...
      tn = class {
        constructor(t, r, n) {
          (this.service = t),
            ...
            (this.anchors = void 0),
            n &&
              (this.unresolvedSchema = this.service.promise.resolve(new xe(n)));
        }
        getUnresolvedSchema() {
          return (
      ...
      at = class {
        ...
        resolveSchemaContent(t, r) {
          ...
          let o = new Set(),
            ...
            a = (m, y, k) => (
              y.anchors || (y.anchors = p(m)), y.anchors.get(k)
            ),
            u = (m, y) => {
              for (let k in y)
                y.hasOwnProperty(k) &&
