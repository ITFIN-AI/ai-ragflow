...
`,
    ...
    var pe = class {
      ...
      provideAttributes(n) {
        ...
        return (
          e && e.attributes.forEach(a), this._globalAttributes.forEach(a), o
        );
      }
      provideValues(n, o) {
        let a = [];
...
`))),
    ...
    var ze = class {
      ...
      _doComplete(n, o, a, e) {
        ...
        function D(k, x = h) {
          return (
            k > h && (k = h), { start: n.positionAt(k), end: n.positionAt(x) }
          );
        }
        function T(k, x) {
          let M = D(k, x);
      ...
      var t = [
          ...
          function (e) {
            ...
            (r.prototype.clone_empty = function () {
              ...
              return (
                i.set_indent(this.__indent_count, this.__alignment_count), i
              );
            }),
            ...
            var I = function (f, d) {
              if (
                ...
                (this.tag_start_char = d.text[0]),
                  ...
                  (this.is_end_tag =
                    !this.is_start_tag || (d.closed && d.closed.text === '/>'));
                var R = 2;
                this.tag_start_char === '{' &&
                  this.text.length >= 3 &&
                  this.text.charAt(2) === '~' &&
